...
int main()
{
	...
	MacroCommand* pmc1 = new MacroCommand();
	pmc1->addCommand(new AddRectCommand(v));
	pmc1->addCommand(new AddCircleCommand(v));
	pmc1->addCommand(new DrawCommand(v));

	pmc1->Execute();

	MacroCommand* pmc2 = new MacroCommand();
	pmc2->addCommand(new AddRectCommand(v));
	pmc2->addCommand(pmc1);
